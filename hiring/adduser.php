		...
		<div class="wizard-content-1 clearfix">
			...
			<div class="step-inner-content clearfix position-relative">
				...
				if(isset($_REQUEST['submit'])){
					...
					if($obj->userAdd($name,$username,$email,$password)){
						echo "<div class='text-success mb-4 text-center'><h4>Successfully Added</h4></div>";
					}
					else{
						echo "<div class='text-danger mb-4 text-center'><h4>This Username or Email Already Registered.</h4></div>";	
					}
				...
				<form name="chngpwd" action="adduser.php" method="post" onSubmit="return valid();">
					<table width="600" border="0" class="table table-striped table-hover" cellspacing="0" cellpadding="5">
						<tr>
							...
							<td width="347"><input type="text" class="form-control input-large" name="username" required   /></td>
						</tr>
						<tr>
							<th width="90" scope="row" style="text-align:right" >Name</th>
							<td width="347"><input type="text" class="form-control input-large" name="name" required /></td>
						</tr>
						
						<tr>
							<th scope="row" style="text-align:right">Email</th>
							<td><input type="text" class="form-control input-large" name="email" required /></td>
						</tr>
						...
						<tr>
							<td colspan="2" style="text-align:center">
								<input type="submit" name="submit" value="Add New User" class="btn btn-success " /></td>
							</tr>
						</table>
					</form>
				</div>
