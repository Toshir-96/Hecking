			...
			<div class="wizard-content-1 clearfix">
					...
					<ul class="tablist multisteps-form__progress">
						...
						<li class="multisteps-form__progress-btn">
							<div class="step-btn-icon-text">
								...
								<div class="step-btn-text">
									<h2 class="text-uppercase"><a href="index.html">Home</a></h2>
								</div>
							</div>
						</li>
					</ul>
				...
				<div class="table-responsive step-inner-content clearfix position-relative">
					...
					if(isset($_REQUEST['id'])){
						if($obj->Delete($_REQUEST['id'],"users")){
							?>
						...
						<tbody>
							...
							foreach($rows as $info){
								...
								<tr>
									...
									<td><a href="useredit.php?edit_id=<?php echo $id;?>" class="btn btn-info">Edit</a> <a class="btn btn-danger" onClick="return confirm('Do you want to delete?');" href="user.php?id=<?php echo $id;?>">Delete</a></td>
								</tr>
								<?php
							}
							?>
				...
				<div><a href="adduser.php" class="pull-right btn btn-primary apply-now">Add User New</a></div>
			</div>
		</div>
	</div>
